module.exports = {
  ...
  {title:Nova Avaliação!}{field:$customemoji[user] | Avaliador:<@$authorid> ($username - $authorid)}{field:$customemoji[star] | Estrelas (max. 5 estrelas):$textinputvalue[estrelasaten_ticket]/5 Estrelas}{field:️$customemoji[escrita] | Avaliação Escrita:$textinputvalue[escritaaten_ticket]}{field:️$customemoji[ok] | Média de Avaliações do Servidor:$roundTenth[$divide[$getGuildVar[tavaliacoes;$getGlobalUserVar[guildid]];$getGuildVar[qavaliacoes;$getGlobalUserVar[guildid]]];1] Estrelas ($getGuildVar[qavaliacoes;$getGlobalUserVar[guildid]] avaliações)}} {actionRow:{button:Atendido por $username[$getGlobalUserVar[assumido_ticket]]:secondary:atendidopor:true:️$customemoji[assumir]}}]
