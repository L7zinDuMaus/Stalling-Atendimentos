module.exports = {
  ...
  $onlyif[$getGuildVar[titulo1]$getGuildVar[titulo2]$getGuildVar[titulo3]$getGuildVar[titulo4]$getGuildVar[titulo5]!=;$interactionupdate[❌️** | Não há nenhuma categoria existente no momento.** {actionRow: {button:Ir para Menu de Opções:danger:gerenciaropcoes_ticket::🔙}}]]
  $onlyPerms[administrator;$interactionReply[**❌️ | Você não tem permissão para usar este comando.**]
