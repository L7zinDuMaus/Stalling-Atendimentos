...
$switch[$getSelectMenuValues[all;,];
  {case:opcao1}
    $setGuildVar[emoji5;$getGuildVar[emoji4]]
    $setGuildVar[emoji4;$getGuildVar[emoji3]]
    $setGuildVar[emoji3;$getGuildVar[emoji2]]
    $setGuildVar[emoji2;$getGuildVar[emoji1]]
    
    $setGuildVar[desc5;$getGuildVar[desc4]]
    $setGuildVar[desc4;$getGuildVar[desc3]]
    $setGuildVar[desc3;$getGuildVar[desc2]]
    $setGuildVar[desc2;$getGuildVar[desc1]]
    
    $setGuildVar[titulo5;$getGuildVar[titulo4]]
    $setGuildVar[titulo4;$getGuildVar[titulo3]]
    $setGuildVar[titulo3;$getGuildVar[titulo2]]
    $setGuildVar[titulo2;$getGuildVar[titulo1]]
  ...
  {case:opcao5}
    // Caso precise de alguma ação específica para essa opção, pode adicionar aqui.
]
