module.exports = {
  ...
  {newEmbed: {title:Opções Criadas} {color:$getGuildVar[color_ticket]} {footer:$guildname | Todos os Direitos Reservados}{author:$guildname | Atendimentos}{thumbnail:$guildicon}
    $if[$getGuildVar[emoji1]!=n;{field:1. $getGuildVar[emoji1] | $getGuildVar[titulo1]:$getGuildVar[desc1]};$if[$getGuildVar[emoji2]!=n;{field:2. $getGuildVar[emoji2] | $getGuildVar[titulo2]:$getGuildVar[desc2]};$if[$getGuildVar[emoji3]!=n;{field:3. $getGuildVar[emoji3] | $getGuildVar[titulo3]:$getGuildVar[desc3]};$if[$getGuildVar[emoji4]!=n;{field:4. $getGuildVar[emoji4] | $getGuildVar[titulo4]:$getGuildVar[desc4]};$if[$getGuildVar[emoji5]!=n;{field:5. $getGuildVar[emoji5] | $getGuildVar[titulo5]:$getGuildVar[desc5]}]]]]] }
 $nonescape[$get[menu2]]]
 $let[menu2;$get[menu]]
